    ...
    menuItems: [
      {
        ...
        label: "Dashboard",
        route: "#",
        children: [{ label: "Seller", route: "/merchant" }],
      },
      {
        icon: (
          <svg
        ...
        icon: (
          ...
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M12 2C10.343 2 9 3.343 9 5s1.343 3 3 3 3-1.343 3-3-1.343-3-3-3zM7 13c-1.657 0-3 1.343-3 3s1.343 3 3 3h10c1.657 0 3-1.343 3-3s-1.343-3-3-3H7z"
            />
          </svg>
        ),
        label: "Employee",

              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full rounded-lg border py-2 pl-4 pr-10 text-black outline-none ${errors.username ? "border-red-500 dark:border-red-500" : " border-stroke focus:border-primary focus-visible:shadow-none "}`}
                    {...register("username")}
                  />
                  {errors.username && (
